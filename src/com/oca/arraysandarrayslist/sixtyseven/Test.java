package com.oca.arraysandarrayslist.sixtyseven;
...
class Test {
    ...
    public static void main(String[] args) {
        ...
        int i = 0;
        arr[i++] = arr[++i] = 40; //Line n2 /  40, 20, 40
//        arr[1] = arr[++i] = 40; //Line n2 /  40, 20, 40
//        arr[1] = arr[2] = 40; //Line n2 /  40, 20, 40
//        arr[1] = (arr[2] = 40); //Line n2 /  40, 20, 40
        for (int x : arr)
...
/*
    ...
    Let's solve the expression now. Left operand is 'arr[i++]' and right operand is '(arr[++i] = 40)'. Left operand is
    evaluated first.
