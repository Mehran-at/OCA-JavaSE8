package com.oca.arraysandarrayslist.sixtytwo;
...
class Test {
    ...
    public static void main(String[] args) {
        ...
        List<String> subList = list.subList(1, 2); //Line n1. (O T) This change will reflect on the original list.
        subList.set(0, "E"); //Line n2. (E T) This change will reflect on the original list. As sublist is backed by the original list.
...
/*
    ...
    list.subList(1, 2) --> [O] (fromIndex is inclusive and endIndex is exclusive, so start index is 1 and end index is
    also 1). subList --> [O].

    At Line n2, `subList.set(0, "E");` => sublist --> [E]. This change is also reflected in the backed list, therefore
    after this statement, list --> [P, E, T]
