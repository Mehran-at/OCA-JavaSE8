package com.oca.stringbuilder.twelve;
...
/*
    ...
    System.out.println(text.concat("ONE ELEVEN ").trim()); //As String is immutable, hence there is no change in the
    String object referred by 'text', 'text' still refers to "ONE "
