package com.oca.datatypesoperatorsvariables.sixtyseven;
...
/*
    ...
    System.out.println(((flag = true) | (flag = false)) || (flag = true)); //bitwise inclusive OR | has higher
    precedence over logical OR ||. flag = false

    || has two operands, Left: ((flag = true) | (flag = false)) and Right: (flag = true). Left operand needs to be
    evaluated first.
