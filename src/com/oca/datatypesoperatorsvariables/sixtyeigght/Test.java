package com.oca.datatypesoperatorsvariables.sixtyeigght;
...
/*
    ...
    "Jaava".replace("aa", "A") --> returns new String object "JAvA".

    "Jaava".replace("aa", "aa") --> returns new String object "Java" (it replaces "a" with "a").

    "Java".replace("mm", "M") --> returns the source String object "Java" (no change).

    As String, StringBuilder and StringBuffer all implement CharSequence, hence instances of these classes can be passed
    to replace method. Line n1 compiles successfully and on execution replaces "N" with "THET", and hence Line n1 prints
    PATHETIC on to the console.
 */