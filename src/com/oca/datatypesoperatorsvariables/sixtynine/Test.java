package com.oca.datatypesoperatorsvariables.sixtynine;
...
class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println((((false) == flag2) != flag3) == (true)); //Line n1
        System.out.println(((true) != flag3) == (true)); //Line n1
        System.out.println((false) == (true)); //Line n1
        System.out.println(false); //Line n1

        System.out.println("\n");
        System.out.println(flag1 = flag2 != flag3 == !flag4); //Line n2
        System.out.println(flag1 = (false != true) == (!flag4)); //Line n2
        System.out.println(flag1 = (true) == true); //Line n2
        System.out.println(flag1 = true); //Line n2
    }
}
/*
    ...
    Above expression is left with single operator ==, whose left side is: (((!flag1) == flag2) != flag3) and right side
    is: (!flag4). As == is a binary operator, so left side is evaluated first.
    ...
    One suggestion: In the real exam, if you find a question containing multiple expressions, then first check if there
    is any compilation error or not. If there is no compilation error in all the expressions, then only solve the expressions.
 */