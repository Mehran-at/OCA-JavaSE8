package com.oca.loop.twentyone;
...
/*\
    "Integer" and "inner" are valid label names.
    ...
    Boolean expression of if(i == 4) evaluates to true. break Integer; statement executes and takes the control out of do-while loop.
