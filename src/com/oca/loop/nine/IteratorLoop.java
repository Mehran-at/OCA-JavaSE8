...
class IteratorLoop {
    ...
    public static void main(String[] args) {
        ...
        List<String> dryFruts = new ArrayList<>();
        dryFruts.add("Walnut");
        dryFruts.add("Apricot");
        dryFruts.add("Almond");
        dryFruts.add("Date");

        Iterator<String> iterator = dryFruts.listIterator();
        while (iterator.hasNext()) {
            String dryFruit = iterator.next();
            if (dryFruit.startsWith("A")) {
                dryFruts.remove(dryFruit);
            }
        }
        System.out.println(dryFruts);
    }
}
/*
    Con`currentModificationException exception may be thrown for following condition:
